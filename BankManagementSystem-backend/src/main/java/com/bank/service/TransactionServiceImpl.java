...
public class TransactionServiceImpl implements TransactionService {
    ...
    @Override
    public void recordDeposit(Long toAccountId, double amount) {
        recordTransaction(toAccountId, amount, "DEPOSIT");
    }

    @Override
    public void recordWithdrawal(Long fromAccountId, double amount) {
        recordTransaction(fromAccountId, amount, "WITHDRAW");
    }
